  ...
  group(
    ...
    () {
      test("getValue<T>(String key, T defaultValue)", () {
        ...
        expect(shareProxy.getValue<String>("key", "qwerty"), equals("qwerty"));
        shareProxy.update("key", "ytrewq");
        expect(shareProxy.getValue<String>("key", "qwerty"), equals("ytrewq"));
      });
      ...
      test("notifyListeners(String key, dynamic value)", () {
        final mockCallback = MockCallback();
        final shareProxy = ShareProxy();
      ...
      test("deleteAllListenersByKey(String key)", () {
        final mockCallback = MockCallback();
        final shareProxy = ShareProxy();
        final secondShareProxy = ShareProxy();
        shareProxy.addListener("key", (event) {
      ...
      test("deleteAllListenersByListKey(List<String> listKey)", () {
        final mockCallback = MockCallback();
        final shareProxy = ShareProxy();
        final secondShareProxy = ShareProxy();
        shareProxy.addListener("key", (event) {
      ...
      test("deleteListenerByListenerId(String key)", () {
        final mockCallback = MockCallback();
        final shareProxy = ShareProxy();
        final secondShareProxy = ShareProxy();
        shareProxy.addListener("key", (event) {
      ...
      test("deleteListenersByListenerId(List<String> listKey)", () {
        final mockCallback = MockCallback();
        final shareProxy = ShareProxy();
        final secondShareProxy = ShareProxy();
        shareProxy.addListener("key", (event) {
